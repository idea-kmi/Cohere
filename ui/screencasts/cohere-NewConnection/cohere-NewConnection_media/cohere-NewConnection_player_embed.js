var videosubdirectory = "cohere-NewConnection_media/";
var videofile = "cohere-NewConnection.avi";
...
var oeTags = '<object id="mediaPlayer" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6"'
         + 'width="956" height="649"'
         + 'codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=5,1,52,701"'
         + 'standby="Loading Microsoft Windows Media Player components..."'
         + 'type="application/x-oleobject">'
         + '   <param name="autoStart" value="true"/>'
         + '   <param name="url"       value="cohere-NewConnection_media/cohere-NewConnection.avi" />'
